...
echo -e "\nSquashFS image build at: ${LTSP_BASEDIR}/images/${LTSP_IMAGE}.img" | tee -a "$INFO_FILE"

mkdir -p "${DEPLOY_DIR}"
rm -f "$DEPLOY_DIR/${LTSP_IMAGE}.img"
ln -s "${LTSP_BASEDIR}/images/${LTSP_IMAGE}.img" "${DEPLOY_DIR}/${IMG_FILENAME}${IMG_SUFFIX}.img"
